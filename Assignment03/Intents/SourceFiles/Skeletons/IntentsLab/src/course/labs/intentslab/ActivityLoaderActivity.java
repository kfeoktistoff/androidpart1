...
public class ActivityLoaderActivity extends Activity {
    ...
    static public final String LABEL_TEXT = "labelText";
	...
	private void startImplicitActivation() {
		...
		Intent choosenIntent = Intent.createChooser(baseIntent, CHOOSER_TEXT);

        
		Log.i(TAG, "Chooser Intent Action:" + choosenIntent.getAction());
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK
                ...
                && data.getStringExtra("labelText") != null
                && !data.getStringExtra("labelText").isEmpty()) {
            mUserTextView.setText(data.getStringExtra("labelText"));
        }
    }
}
