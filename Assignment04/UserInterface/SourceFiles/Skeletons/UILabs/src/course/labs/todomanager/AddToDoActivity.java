	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
                ...
                View priorityRadioButton = mPriorityRadioGroup.findViewById(mPriorityRadioGroup.getCheckedRadioButtonId());
                Priority priority = Priority.values()[mPriorityRadioGroup.indexOfChild(priorityRadioButton)];
