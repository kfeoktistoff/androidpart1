...
public class ActivityTwo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
            ...
            mCreate = (Integer)savedInstanceState.get("onCreate");
            mRestart = (Integer)savedInstanceState.get("onRestart");
            mResume = (Integer)savedInstanceState.get("onResume");
            mStart = (Integer)savedInstanceState.get("onStart");
		}
